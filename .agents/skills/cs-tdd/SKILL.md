...
See [Definition of Done](../../references/cs-definition-of-done.md) for check frequency and `../../references/cs-testing-patterns.md` for detailed patterns and framework-specific examples.
