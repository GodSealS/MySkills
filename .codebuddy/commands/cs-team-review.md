...
For DDD projects, follow the skill's task-specific context handoff: supply dual-layout inventory, relevant specs/ADRs, affected document/source snapshots and phase-appropriate structural/content evidence. Missing necessary context blocks dependent conclusions; absent SysDocs or unrelated historical defects do not force full initialization/repair. Maintenance remains outside this read-only run. The Team Review JSON validator does not establish SysDocs compliance or semantic correctness.
