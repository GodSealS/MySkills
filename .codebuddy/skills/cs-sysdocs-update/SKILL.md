...
argument-hint: "[project_root] [--mode repair|incremental|rebuild-boundaries] [--source-scope committed|committed+working-tree|unversioned] [--kb <backend>] [--yes] [--files <list>]"
user-invocable: true
